...
export class OrdersService {
  ...
  async executeTransaction(input: InputExecuteTransactionDto) {
    ...
    // Atomicity - the transaction is either fully completed or not at all
    // $transaction will automatically rollback the transaction if an error is thrown inside the callback.
